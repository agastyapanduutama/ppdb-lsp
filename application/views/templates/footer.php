                ...
                <div class="col-lg-3 col-md-6">
                    <div class="">
                        ...
                        <nav class="list-unstyled">
                            ...
                            <li class="list-space">
                                <a href="" class="list-menu">Wisata</a>
                            </li>
                            <li class="list-space">
        ...
        <div class="border-color info-footer">
            ...
            <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
                ...
                <nav class="mx-auto d-flex flex-wrap align-items-center justify-content-center gap-4">
                    <a href="" class="footer-link" style="text-decoration: none">Kebijakan dan Ketentuan</a>
                    <span>|</span>
                    <a href="" class="footer-link" style="text-decoration: none">Kebijakan privasi</a>
                </nav>
                <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
                    <p style="margin: 0">Copyright © 2021 <a style="color:grey" href="bingkaikode.com" class="text-decoration-none"><b>Bingkai Kode</b></a> </p>
                </nav>
            </div>
        </div>
    </div>
