    ...
    <div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif">
        ...
        <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
            <div class="right mx-lg-0 mx-auto">
                ...
                ?>
                <form style="margin-top: 1.5rem" action="<?= base_url('siswa/masuk/aksi') ?>" method="post">
                    <div style="margin-bottom: 1.75rem">
                        ...
                        <div class="d-flex w-100 div-input">
                            ...
                            <input class="input-field border-0" type="number" name="nik" id="" placeholder="NIK anda sebagai Username" autocomplete="on" required />
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end" style="margin-top: 0.75rem">
                        <a href="<?= base_url('user/lupa') ?>" class="forgot-password fst-italic">Lupa Password?</a>
                    </div>
                ...
                <p class="text-center bottom-caption">
                    Belum Punya akun?
                    <span class="green-bottom-caption "><a class="text-decoration-none" href="<?= base_url('user/daftar') ?>">Daftar disini</a></span>
                </p>
            </div>
        </div>
    </div>
